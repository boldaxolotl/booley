...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("D19", "booley.review.generation", "booley.ticket_board.io", "seed.py"),
        ("D19", "booley.review.generation", "booley.harness.booley", "seed.py"),
        ("D20", "booley.ticket_board.io", "booley.review.artifact", "seed.py"),
