...
class TestElabResolution:
    ...
    def test_prepare_drives_make_over_resolved_build_root(self, tmp_path):
        ...
        with (
            ...
            patch("booley.flows.elaborate.validate_top_parameter_intent") as guard,
        ):
    ...
    def test_vivado_elaboration_stops_at_synthesis_target(self, tmp_path):
        ...
        with (
            ...
            patch("booley.flows.elaborate.validate_top_parameter_intent"),
        ):
...
def test_run_consults_config_fallback_before_refusing(tmp_path, monkeypatch):
    ...
    from booley.flows import elaborate as elab_mod
...
class TestScanDeclarations:
    ...
    def test_finds_modules_and_shared(self):
        from booley.flows.elaborate import _scan_hdl_declarations
...
class TestStandaloneFrontend:
    ...
    def test_auto_prefers_verilator_when_installed(self, tmp_path, monkeypatch):
        ...
        import booley.flows.elaborate as elab_mod
