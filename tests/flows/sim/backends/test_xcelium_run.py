"""Unit tests for booley.flows.sim.backends.experimental.xcelium — the broker-era Xcelium parse-half.
...
from booley.flows.sim.backends.experimental.xcelium import (
...
class TestOfflineCli:
    """`python -m booley.flows.sim.backends.experimental.xcelium --parse-log` — the copy-back loop helper."""
