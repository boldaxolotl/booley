"""Unit tests for booley.flows.sim.backends.experimental.vcs — the broker-era VCS parse-half.
...
from booley.flows.sim.backends.experimental.vcs import (
    evaluate_vcs_log,
    main,
    reemit_vcs_summary,
)
...
class TestOfflineCli:
    """`python -m booley.flows.sim.backends.experimental.vcs --parse-log` — the copy-back loop helper."""
