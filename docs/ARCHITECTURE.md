...
This is the big-picture view of Booley and how its parts fit together. It assumes familiarity with the terms **Booley Flow**, **Target**, **Specialist**, **Session Runtime**, and FuseSoC `.core`; all are defined in the [CONTEXT.md glossary](CONTEXT.md). Operational commands and capability details belong in [USAGE.md](USAGE.md), while each section below links to deeper technical documentation.
...
Tickets and their transitions live on the filesystem-backed Ticket Board. Their schema, Criteria, queue lifecycle, concurrency, and CLI are documented in [USAGE.md](USAGE.md#ticket-driven-workflow); canonical terminology is in [CONTEXT.md](CONTEXT.md#work-management).
