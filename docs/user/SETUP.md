...
name, Bootstrap removes those version tags without forced deletion or parent
pruning. Retag an official image under your own repository name if you need to
keep a separately named pinned copy.
