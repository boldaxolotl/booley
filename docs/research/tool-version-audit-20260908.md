# External program version audit - 2026-09-08

This audit covers every executable, compiler, runtime, immutable image, and
build or publication tool that `origin/main` at
`07ca5d2e8aec22ec5aa0a8cd778c52551232e653` pins or invokes. Publisher
production channels were queried on 2026-09-08. Prereleases were excluded.

The refresh identified on 2026-09-07 landed in PR #394 before this release
base. Its Claude Code, Codex CLI, NumPy, PyYAML, Docker, and Verilator changes
are current. This audit found no pending routine update, so no separate
toolchain-refresh PR is required before release 0.2.15.
...
| Verilator | `v5.052` / `ea338be9...` | `v5.052` | [Verilator v5.052](https://github.com/verilator/verilator/tree/v5.052) | **current**: the compiler, Cocotb, FST, diagnostic, and coverage migration completed before this release base. |
...
| NumPy | `2.5.3` | `2.5.3` | [PyPI](https://pypi.org/project/numpy/) | **current** |
...
| --- | --- | --- | --- | --- |
| Claude Code | `2.1.263` | `2.1.263` | [npm](https://www.npmjs.com/package/@anthropic-ai/claude-code) | **current** |
| Codex CLI | `0.153.4` | `0.153.4` | [Codex 0.153.4](https://github.com/openai/codex/releases/tag/rust-v0.153.4) | **current** |
...
| Docker CLI in reaper | `29.8.0-cli@sha256:eccaacfe...` | same tag and index digest | [Docker 29.8.0](https://github.com/moby/moby/releases/tag/docker-v29.8.0), [official image](https://hub.docker.com/v2/repositories/library/docker/tags/29.8.0-cli) | **current** |
| Docker-in-Docker evidence service | `29.8.0-dind@sha256:5efed980...` | same tag and index digest | [official image](https://hub.docker.com/v2/repositories/library/docker/tags/29.8.0-dind) | **current** |
...
| PyYAML semantic checker | `6.0.3` | `6.0.3` | [PyPI](https://pypi.org/project/PyYAML/) | **current** |
