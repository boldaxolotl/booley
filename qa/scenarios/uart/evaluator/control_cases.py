...
def control_cases() -> list[tuple]:
    ...
    return [
        ...
        *timeout_cases(),
        ...
        peripheral("rx-rates", "rate", "control-rx-rates"),
        peripheral("parity-errors", "parity_error", "control-parity-errors"),
        peripheral("overflow", "overflow", "control-overflow"),
        peripheral("breaks", "break", "control-breaks"),
        peripheral("watermarks", "watermark", "control-watermarks"),
