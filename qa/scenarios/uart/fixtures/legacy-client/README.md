# SESSION-RUNTIME-LIFECYCLE legacy Sandbox Attachment fixture procedure
...
command reported by Booley. Capture file hashes and Docker and Sandbox Attachment evidence before
