...
| `taxi-10g-mac-port-evolution.physical.recipe-identity` | Core | Baseline/candidate/final use same selected library/technology and physical recipe. | Exact Runtime Image, EDA tool, library, and recipe identities and pair comparison. |
