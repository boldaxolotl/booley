...
Used by the mission's `seed-ticket2` area. Submit the shared settings below plus the Ticket 2 section verbatim as the Ticket payload; Ticket Create must not infer omitted semantics:
