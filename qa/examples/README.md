...
and Check Results are examples, not execution evidence. It grants no coverage credit.
...
The Scenario uses the production [JSON Schema](../scenario.schema.json). Check Result
