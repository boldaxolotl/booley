...
from booley.job_slots import SlotCaps
...
def _make_backend(provider: str, auth_mode: str) -> Any:
    ...
    if provider == "claude":
        from .agent_backend import ClaudeSDKBackend
...
def _parse_jobs_config(data: dict) -> SlotCaps:
    ...
    """
    from booley.job_slots import parse_caps
...
def load_models_config(project_root: Path) -> None:
    ...
    from .config import MODEL_MAP, STEP_TIERS
