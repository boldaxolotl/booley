...
from ._backend_config import (  # noqa: F401 — re-exported as public API of harness.config
    _DEFAULT_PROVIDER,
...
from ._editor_config import (  # noqa: F401 — re-exported as public API of harness.config
    VSCODE_EDITOR,
    ResolvedEditor,
)

# --- Re-exports: harness limits (owned by _limits.py) ---
from ._limits import (  # noqa: F401 — re-exported as public API of harness.config
...
from ._retry import (  # noqa: F401 — re-exported as public API of harness.config
