...
class _SessionImages:
    ...
    def inspect(self, project_root: Path, *, verbose: bool) -> None:
        self._inspection = init_cmd.inspect_refreshable_session_image(
            project_root,
            verbose=verbose,
        )
    ...
    def refresh(
        ...
        *,
        ...
        result = init_cmd.refresh_session_image(
            project_root,
            verbose=verbose,
...
def refresh(
    ...
    *,
    ...
    return runtime_refresh.refresh(project_root, _SessionImages(), verbose=verbose)
