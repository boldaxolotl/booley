...
Prices live in :mod:`booley.pricing` — the one table shared with the
ticket-board reports. This module is the harness-facing wrapper.
"""

from __future__ import annotations

from booley.pricing import MODEL_PRICING as _MODEL_PRICES  # noqa: F401 — legacy alias
from booley.pricing import estimate_cost
