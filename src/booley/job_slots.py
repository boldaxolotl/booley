...
Pure + stdlib-only, like ``mcp_tools.mcp_job_records`` (whose deadline/identity
...
from booley.mcp_tools.job_records import (
    DEADLINE_SLACK_SECONDS,
    _proc_cmdline,
    parse_stamp,
)
from booley.timefmt import rfc3339_from_epoch
