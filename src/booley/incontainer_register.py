...
booley.incontainer_register``, does two things on every container start:
...
from booley.mcp_server import HTTP_ENDPOINT_PATH, http_port

MCP_SERVER_NAME = "booley"
_TOOL_TIMEOUT_SEC = 7200

# How this module launches the shared per-container HTTP server.
_SERVER_CMD = [sys.executable, "-m", "booley.mcp_server", "--transport", "http"]
