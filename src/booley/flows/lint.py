...
def _lint_eda_tool_family(eda_tool: str | None) -> str:
    ...
    Mirrors :func:`booley.flows.sim_edam.normalize_eda_tool` (ADR 0022
...
class LintFlow(BooleyFlow):
    ...
    def _run_lint_target(
        ...
        except Exception as exc:  # noqa: BLE001 — isolate per-target lint setup failure; recorded as a target error
