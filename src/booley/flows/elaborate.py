...
class ElaborateFlow(BooleyFlow):
    ...
    def _asic_frontend_inputs(self, resolved: Any) -> _AsicElabInputs:
        ...
        """
        # Imported lazily and by their private names: this is the same
        ...
        # RTL configurations.
        from .asic_synthesize import _vlogdefine_args, _vlogparam_args
        ...
        return _AsicElabInputs(
            ...
            params=dict(a.split("=", 1) for a in _vlogparam_args(resolved.parameters)),
        )
