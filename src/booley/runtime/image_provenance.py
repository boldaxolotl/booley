"""Shared Sandbox Image provenance schema and canonical recipe hashing."""
...
LABEL_RUNTIME_BASE_CONTRACT = "io.booley.runtime-base.contract"
LABEL_STANDARD_SUBSTRATE_CONTRACT = "io.booley.standard-substrate.contract"
