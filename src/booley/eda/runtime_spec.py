...
from .vivado import CONTAINER_TARGET, POLICY_REVISION, wrapper_sha256
    ...
    try:
        with authority.resolve_for_issuance(project, host_provisioning) as (
            ...
            if profile is not None:
                from .flexnet_docker import resources_for_session
...
def _relay_image_id(profile: authority.LicenseProfile) -> str:
    ...
    del profile
    from .flexnet_docker import RelayDockerError, resolve_relay_image_id
