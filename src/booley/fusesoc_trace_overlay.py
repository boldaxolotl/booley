...
Extracted from :mod:`booley.fusesoc_registry` (principle 8 / SRP). That module's
...
(:func:`~booley.fusesoc_registry.enumerate_targets`, ``read_core``,
...
from booley.core_projection import native_cores_ignored, projected_core_path, projection_enabled
...
def _target_dump_module_entry(
    ...
    """
    from booley.fusesoc_registry import target_fileset_names
...
def target_includes_dump_module(project_root: Path | str, target: str) -> bool:
    ...
    """
    from booley.fusesoc_registry import FuseSocError, read_core, resolve_ref
...
def _inject_runtime_dump_trace(
    ...
    """
    from booley.fusesoc_registry import TRACE_OVERLAY_MARKER
