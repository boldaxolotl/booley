...
def _get_prefixes(
    ...
    if parsed is None:
        try:
            from booley.shared_infra import get_rtl_prefixes, get_tb_prefixes
...
def _warn_unregistered_sources(
    ...
    if not work_dir:
        return
    try:
        from booley.fusesoc_registry import classified_sources, discover_cores
...
# Guide paths — resolved at call time via booley.paths
