...
from booley.timefmt import format_human_datetime, format_human_datetime_safe

from . import job_records as jobrec
...
class SubmitRunReportMcpTool(McpTool):
    ...
    def _criteria_freshness_gate(self) -> McpToolResult | None:
        ...
        from booley.harness.criteria_acceptance import refresh_verification_freshness
