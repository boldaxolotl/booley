...
class CoverageAnalystSpecialist(Specialist):
    ...
    # Nested-MCP allowlist lives in booley.nested_mcp_capabilities.
...
"""
    ...
    def _scan_tb_for_dump_calls(
        ...
        """
        from booley.shared_infra import get_tb_dirs
    ...
    def _diagnose_trace_run_failure(
        ...
        from .simulate import _detect_dut_info_diagnostic
    ...
    def _ensure_trace(self, trace_dir: Path, work_dir: Path) -> McpToolResult | None:  # noqa: PLR0911 — each prerequisite check returns its own early error McpToolResult
        ...
        from .simulate import SimulateFlow
