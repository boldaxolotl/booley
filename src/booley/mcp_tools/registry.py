...
# Modules in the endpoint packages that must be excluded from discovery even though (or
...
def discover_mcp_tools(
    *,
    ...
    Args:
        booley_src: Path to booley ``src/`` directory (contains ``flows/`` and ``mcp_tools/``).
