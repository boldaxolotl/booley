...
from booley.nested_mcp_capabilities import nested_mcp_tools_for
from booley.zombie_cleanup import _descendant_pids as _zombie_descendant_pids

from .base import EXIT_ERROR, McpTool, McpToolResult
...
class Specialist(McpTool):
    ...
    # ``booley.nested_mcp_capabilities.NESTED_MCP_CAPABILITIES`` and are
    ...
    def _resolve_model(self) -> str:
        ...
        try:
            from booley.harness.config import get_backend_config
    ...
    def _invoke_agent(
        ...
        from ``booley.nested_mcp_capabilities`` when the caller hasn't
    ...
    def _make_streaming_callback(self) -> Any:
        ...
        from .base import _specialist_thinking_event, _write_display_event
    ...
    def _git_add_and_commit(
        ...
        from booley.harness.git_utils import git_run
...
def _call_agent_sync(
    ...
    from booley.harness.agent import call_agent
